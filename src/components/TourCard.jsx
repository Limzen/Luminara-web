  ...
  <div className="tour-card new-tour-card">
    ...
    <div className="tour-card-content new-tour-card-content">
      ...
      <div className="tour-card-info-row">
        ...
        <span className="tour-card-info"><LocationIcon /> <span className="tour-card-location">Jl. Sakura III, Taman Sakura Indah</span></span>
      </div>
      <div className="tour-card-desc">
        {tour.description}
      </div>
      <a href="#" className="tour-card-link">Explore Detail</a>
    </div>
  </div>
);
